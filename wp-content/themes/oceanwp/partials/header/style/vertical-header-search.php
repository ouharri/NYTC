...
<div id="vertical-searchform" class="header-searchform-wrap clr">
	<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-searchform" aria-label="<?php esc_attr_e( 'Vertical Header Search', 'oceanwp' ); ?>">
		...
		?>
		<button class="search-submit"><?php oceanwp_icon( 'search' ); ?></button>
